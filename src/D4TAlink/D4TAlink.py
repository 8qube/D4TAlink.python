...
D4TAlink (https://d4ta.link/) enables seamless compliance of data analysis pipelines with FAIR data and ALCOA principles. 
D4TAlink comprises two software packages in R and python. 
"""
